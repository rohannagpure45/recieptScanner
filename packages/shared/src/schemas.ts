...
export type ReceiptParsedData = ParsedReceipt;
export type Guest = z.infer<typeof GuestSchema>;
export type GuestList = z.infer<typeof GuestsArraySchema>;
export type AssignmentsMapping = z.infer<typeof AssignmentsMappingSchema>;
